 ...
 * assets (the source-hosted quick-link icons) must be left as plain <img> so they
 * are not rewritten into ?format=webply renditions the remote host can't serve.
